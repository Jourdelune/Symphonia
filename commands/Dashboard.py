...
class Dashboard(commands.Cog):
    ...
    async def dashboard(self, ctx):
        ...
        """Dashboard link"""
        embed = discord.Embed(color=embed_color(ctx.guild.id), description="[Dashboard link](https://songs-bot.tk/me)")
        embed.set_author(name=f"Dashboard of song's Bot", icon_url=ctx.author.avatar_url)
